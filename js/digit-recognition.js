...
function preprocessCanvas(image) {
	...
	let tensor = tf.browser.fromPixels(image)
		...
		.expandDims()
		.toFloat();
	console.log(`canvas preprocessed, resulting tensor shape: ${tensor.shape}`);
...
async function makePredictionAndUpdateChart() {
	...
	let raw_predictions = await model.predict(tensor).data();
...
function displayLabel(predictions) {
